<?php
	...
	//destination details
		...
		$apps[$x]['destinations'][$y]['select_value']['user_contact'] = "sofia/internal/\$1\@\${regex(\${sofia_contact(\${destination}@\${domain_name})}|^[^@]*@(.*)$|%1)}";
		$apps[$x]['destinations'][$y]['select_value']['dialplan'] = "bridge:sofia/internal/\$1@\${regex(\${sofia_contact(\${destination}@\${domain_name})}|^[^@]*@(.*)$|%1)}";
		$apps[$x]['destinations'][$y]['select_value']['ivr'] = "menu-exec-app:bridge sofia/internal/\$1@\${regex(\${sofia_contact(\${destination}@\${domain_name})}|^[^@]*@(.*)$|%1)}";
